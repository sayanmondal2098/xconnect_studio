      ...
      <div className="w-full max-w-md">
        <div className="mb-4 flex items-center justify-center gap-2 text-muted">
          ...
          <div className="text-sm">
            ...
            <div className="text-xs text-muted">Sign in to build your next automation.</div>
          </div>
        </div>

        <Card title="Login" subtitle="Because humans love passwords.">
          ...
          <div className="text-sm text-muted mt-3">
            No account?{" "}
            <Link className="text-lavender underline underline-offset-4" to="/register">
              Register
            </Link>
          </div>
        </Card>
